    ...
    return (
        <div>
            ...
            <div className='fpropertyItem '>
                ...
                <h2 className='font-bold text-[#262626]'>3 Epoques Apartments by Prague Residences </h2>
                <span className='fpropertyCity text-sm text-gray-600'> Prague 1, Czech Republic, Praha 1</span>
                <p className='text-sm text-gray-600'>Starting from<span className='font-bold  fPropertyPrice '> BDT 24,727</span></p>
